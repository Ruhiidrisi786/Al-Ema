    ...
    <div className="container py-5" style={{ marginTop: "100px" }}>
      ...
      <div className="text-center">
        <h1 className="fw-bold display-4 mb-3">
          Premium Crude Oil Supply
        </h1>

        <p className="fs-5 text-secondary mx-auto" style={{ maxWidth: "850px" }}>
          Leading supplier of high-quality crude oil to global markets.
          We ensure reliability, quality, and competitive pricing for all your petroleum needs.
        </p>
      </div>
